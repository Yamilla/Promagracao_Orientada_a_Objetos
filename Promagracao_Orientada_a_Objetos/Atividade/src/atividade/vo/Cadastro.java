...
public class Cadastro { //tratar erro do codigo diferente ao deletar
    ...
    public void cadastrarFuncionario() {
        ...
        System.out.println("O cadastro foi removido com sucesso");
        System.out.println("-------------------------------------------------------");
        System.out.println("");
    ...
    public void deletarFuncionario() {                        // problema no deletar       //tratar o vazio
        Scanner ler = new Scanner(System.in);
        Funcionario fun = new Funcionario();
    ...
    public void cadastrarSetor() {
        ...
        System.out.println("O cadrastro setor foi realizado com sucesso");
        System.out.println("-------------------------------------------------------");
        System.out.println("");
